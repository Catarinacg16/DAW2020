    ...
    <body>
        <div class="w3-card-4">
            ...
            <footer class="w3-container w3-teal">
                <address>Gerado por Catarina :: DAW2020 em ${d} - [<a href="/">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
...
function geraPagTarefas(tarefas, d){
  ...
  `
    ...
    pagHTML += `
            ...
            <center><h3><u>Histórico de Tarefas</u></h3></center>
            <table class="w3-table w3-bordered">
                <tr>
                    <th>Título</th>
                    <th>Data de criação</th>
  ...
  pagHTML += `
        ...
        <div class="w3-container w3-teal">
            <address>Gerado por Catarina :: DAW2020 em ${d}</address>
        </div>
    </body>
    </html>
  `
