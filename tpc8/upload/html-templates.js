        ...
        <body>
            ...
            <form class="w3-container" action="/files" method="POST" enctype="multipart/form-data">
                ...
                <div class="w3-row w3-margin-bottom">
                    ...
                    <div class="we-col s9 w3-border">
                        <input class="w3-input w3-border w3-light-grey" type="file" name="listFile"> 
                    </div>
                </div>
                <div id="adiciona"></div>
            ...
            <footer class="w3-container w3-teal">
                <address>Gerado por upload-single ::DAW2020 em ${d}</address>
            </footer>
        </body>
    </html>
    `
...
function geraPostConfirm( aluno, d){
    ...
    <body>
        <div class="w3-card-4">
            ...
            <footer class="w3-container w3-teal">
                <address>Gerado por upload-single ::DAW2020 em ${d} - [<a href="/">Voltar</a>]</address>
            </footer>
        </div>
    </body>
    </html>
